...
const Spiner = () => {
  return (
    <div className="pro-ui-spinner w-[17px] h-[17px] inline-flex items-center justify-center relative">
      <div role="status">
        <svg
          aria-hidden="true"
          className="w-full h-full fill-main text-secondary animate-spin"
          viewBox="0 0 100 101"
          fill="none"
